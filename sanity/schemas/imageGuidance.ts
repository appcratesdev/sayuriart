...
export const imageGuides = {
  ...
  service: {
    description:
      "Uzycie: kafel uslugi, mobile 4:3, desktop polowa szerokosci panelu i ok. 480px wysokosci, object-cover. Rekomendacja: 4:3, minimum 1600 x 1200px. Ustaw hotspot na najwazniejszy produkt/fragment.",
    minWidth: 1600,
    minHeight: 1200,
    aspectRatio: 4 / 3,
    aspectLabel: "4:3",
